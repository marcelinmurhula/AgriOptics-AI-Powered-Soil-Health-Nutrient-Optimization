This project has been made thanks to Kaggle. The service gave me a ready-to-code environment with all libraries pre-installed, free computing power for my models, and easy dataset handling.
